...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports.create = function (SirTrevor) {
	  function createBlock(e) {
	    ...
	    var defaultBlockType = undefined;
	    ...
	    // REFACTOR: block create event expects data as second argument.
	    /*jshint validthis:true */
	    SirTrevor.mediator.trigger("block:create", SirTrevor.options.defaultType, null, this.parentNode.parentNode.id ? this.parentNode.parentNode : this.parentNode);
	  }
